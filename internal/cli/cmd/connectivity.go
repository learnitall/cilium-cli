...
func newCmdConnectivityTest() *cobra.Command {
	...
	cmd.Flags().BoolVar(&params.PerfTCP_CRR, "perf-tcp-crr", false, "Run Netperf TCP_CRR test")
	cmd.Flags().BoolVar(&params.PerfTCP_RR, "perf-tcp-rr", false, "Run Netperf TCP_RR test")
